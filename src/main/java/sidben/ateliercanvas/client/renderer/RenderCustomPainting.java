...
public class RenderCustomPainting extends Render
{
    ...
    public void doRender(EntityCustomPainting painting, double par2, double par3, double par4, float par5, float par6)
    {
        ...
        */
        tessellator.addVertexWithUV(f + 16, f1 + 0, (double)(-f2), 0, 1);
        tessellator.addVertexWithUV(f + 0, f1 + 0, (double)(-f2), 1, 1);
        tessellator.addVertexWithUV(f + 0, f1 + 16, (double)(-f2), 1, 0);
        tessellator.addVertexWithUV(f + 16, f1 + 16, (double)(-f2), 0, 0);
